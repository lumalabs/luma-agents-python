...
from ..types.image_ref_param import ImageRefParam
from ..types.video_options_param import VideoOptionsParam
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          aspect_ratio: Output aspect ratio. Valid values depend on the selected model and generation
          ...
          source: Media reference for guided generation. Provide exactly one of url, inline base64
          ...
          video: Ray 3.2 video request options. Common output settings live at the top level for
